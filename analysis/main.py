...
def analyse_threat(current_event):
    ...
    with state_lock:
        ...
        if len(flood_tracker[ip]) >= 15:
            ...
            incident = {"incident_type": "REQUEST_FLOOD", "details": "High velocity request flood detected."}
        ...
        if not incident and event_type == "SUSPICIOUS_ENDPOINT":
            ...
            if len(scan_tracker[ip]) >= 6:
                ...
                incident = {"incident_type": "ENDPOINT_SCAN", 
        ...
        if not incident:
            if current_state == "COMPROMISED_SQLI" and event_type == "PATH_TRAVERSAL":
                ...
                current_state = "CRITICAL_COMPROMISE"
                incident = {"incident_type": "ACCOUNT_COMPROMISE", 
                ...
                incident = {"incident_type": "CREDENTIAL_ATTACK", 
        ...
        if not incident and current_score >= 15 and current_state != "CRITICAL_COMPROMISE":
            current_state = "CRITICAL_COMPROMISE" 
            incident = {"incident_type": "CRITICAL_THREAT_SCORE", "details": "Critical suspicious behavior threshold met."}
            ...
            try:
                ...
                if msg_type == 1:  
                    ...
                    if threat_id != 255:  
                        ...
                        event_queue.put(Event(IP=ip_address, 
